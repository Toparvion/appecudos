...
public class CommandLine {
     ...
     * picocli creates a {@link Proxy Proxy} whose methods return the matched command line values.
    ...
    public @interface Option {
         ...
         * <p>May contain embedded {@linkplain Formatter format specifiers} like {@code %n} line separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.
         * </p><p>
    ...
    public @interface Command {
         ...
         * <p>May contain embedded {@linkplain Formatter format specifiers} like {@code %n} line separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.</p>
...
//                }
    ...
    public static class Help {
         ...
         * @deprecated use {@link CommandLine.Help#Help(CommandSpec, CommandLine.Help.ColorScheme)}  */
         ...
         * {@linkplain ParserSpec#separator() separator} string, and, unless
         ...
         * {@link TextTable} to display these values in tabular format. Layout is responsible for deciding which values
         * to display where in the table. By default, Layout shows one option or parameter per table row.</p>
         * <p>Customize by overriding the {@link #layout(ArgSpec, Text[][])} method.</p>
        ...
        public static class Layout {
             ...
             * text values for the specified {@link OptionSpec}, and then calls the {@link #layout(ArgSpec, Text[][])}
             ...
             * {@link #layout(ArgSpec, Text[][])} to write these text values into the correct cells in the TextTable.
